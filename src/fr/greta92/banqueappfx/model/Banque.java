...
//	private ArrayList<Compte> comptes;
	/**
	 * on stocke les comptes dans une ObservableList car elle est utilisée par
	 * ListView comme Model
	 */
	protected transient ObservableList<Compte> comptes;
...
//		return numeroCompte-1;
	...
	class ComparatorAsc implements Comparator<Compte> {
		...
		public int compare(Compte o1, Compte o2) {
			if (o1.getNumeroCompte() > o2.getNumeroCompte()) {
				return 1;
			}
			if (o1.getNumeroCompte() < o2.getNumeroCompte())
				return -1;
...
//	}
	 ...
	 * sérialisation de l'objet Banque cette implémentation crée une ArrayList en
	 * utilisant comptes qui est une ObservableList et l'écrit sur le disque
	 * 
	 * @param oos
	 * @throws IOException
	 */
	 ...
	 * désérialisation de l'objet Banque cette implémentation initialise 'comptes'
	 * qui est un ObservableList avec ArrayList lu du disque
	 * 
	 * @param ois
	 * @throws IOException
